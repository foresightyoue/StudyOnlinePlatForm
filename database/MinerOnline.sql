...
CREATE TABLE `disscussion_reply` (
  ...
  `Reply_Time` timestamp NOT NULL DEFAULT '1970-01-02 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `homework` (
  ...
  `Created_Date` timestamp NOT NULL DEFAULT '1970-01-02 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `Deadline` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `Class_Id` int(11) NOT NULL,
  `StartDate` timestamp NOT NULL DEFAULT '1970-01-02 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
